...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, memory, tgt_is_causal=None, tgt_mask=None, memory_mask=None, memory_is_causal=None, tgt_key_padding_mask=None, memory_key_padding_mask=None):
